...
<html>
    ...
    <!--    <link  href="<c:url value="glider.css"/>" rel="stylesheet" stype="text/css">-->
        ...
        <script src="<c:url value="/resources/js/listDes_1.js"/>"></script>
                        ...
                        <div class="container">
                            <div class="row fullscreen align-items-center justify-content-between">
                                <div class="col-lg-6 col-md-6 banner-left">
                                    <h6 class="text-white">Tìm & Đặt Vé </h6>
                                    <h1 class="text-white">PC Airlines</h1>
                                    <p class="text-white">
                                        Nắm bắt cơ hội du ngoạn vòng quanh thế giới với giá tốt từ PC Airlines.
                                        Đặt vé trực tuyến từ sớm để tiết kiệm tối ưu cho chuyến đi của mình.    
                                    </p>
                                    <a href="<c:url value="/admin/hello"></c:url>" class="primary-btn text-uppercase">Đặt vé cùng chúng tôi</a>
                                    </div>
                                    <div class="col-lg-4 col-md-6 banner-right">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <mvc:form class="form-wrap" action="${pageContext.request.contextPath}/searchFlight" method="GET" modelAttribute="searchInformation">
                                                <mvc:select path="departure" class="form-control" name="from" id="from"  onchange="listDes_1();">
                                                    <mvc:option value="">Từ</mvc:option>
                                                    <c:forEach items="${listPlace}" var="place"> 
                                                        <mvc:option value="${place.toString()}">${place.toString()}</mvc:option>
                                                    </c:forEach>
                                                </mvc:select>

                                                <div id="demo"></div>
                                                <mvc:input path="date" type="date" class="form-control date-picker" required="required"/>
                                                <br> 
                                                <mvc:button id="btnnn" class="primary-btn text-uppercase">Tìm kiếm</mvc:button>
                                            </mvc:form>
                                        </div>
                                    </div>
                                </div>
